-- READ-ONLY: run in Supabase SQL Editor AFTER 20260907170000 migration.
...
with expected(signature) as (
  values ('public.read_assessment_section_navigation_v3(text,text,uuid,integer,boolean,text,uuid,uuid)')
)
