...
- **PERF-012: 226/226 staging checks; 501/501 full tests; performance-приёмка не завершена.**
...
- Следующий шаг: SQL EXPLAIN реальных query shapes и before/after write gate ≤10%; отдельно browser UI/server actions, остальные RLS paths и builder acceptance.
