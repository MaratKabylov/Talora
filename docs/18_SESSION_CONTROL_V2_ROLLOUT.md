...
## Следующий шаг: PERF-004

Ограничить чтение assessment content активной секцией: минимальный session overview,
метаданные секций и вопросы/ответы выбранной секции. Сохранить отсутствие scoring keys
в browser, детерминированный shuffle и восстановление ответов. Приемку PERF-003 на
staging не считать закрытой до фактических замеров и проверки конкурентности.
