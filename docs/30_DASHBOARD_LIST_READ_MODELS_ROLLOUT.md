...
PERF-011 остаётся отдельной задачей для остальных list routes и общей настройки
размера страниц. В PERF-010 их верхнеуровневые коллекции ещё не пагинированы.
